                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <nav>
                                                        <div class="section__container nav__links"><p>
                                                            ...
                                                            <span><a>/</a></span>
                                                            <span><a href="{{url('payrolldata')}}" style="color: #2bff00;">View Payroll history</a></span>
                                                            </div>
                                                    </nav>
                                                                ...
                                                                <table id="PayrollTable" class="table table-striped table-hover text-info shadow">
                                                                    ...
                                                                    <tbody id="Employees-table">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>{{$employee['total_hourpay']}}
                                                                            <td>{{$employee['project_inc']}}</td>
                                                                            <td>{{$employee['total_monthly_payroll']}}</td>
